...
import com.superpromo.superpromo.ui.shopping.product.detail.ProductDetailFragmentArgs
...
@AndroidEntryPoint
class ProductArchiveDetailFragment : Fragment() {
    ...
    private val productArchiveDetailViewModel: ProductArchiveDetailViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        bundle.product?.let {
            ...
            hideEmptyView(it)
            setListeners()
            productArchiveDetailViewModel.setProductId(it.id)
        }
